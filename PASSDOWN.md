...
- **Local uncommitted change:** `phone-bridge/gradle/libs.versions.toml` has `agp = "9.4.0"` (was `9.1.1`).
...
- Local: `C:\Cursor_Projects\ECG-Phone-Bridge` — open `phone-bridge` in Android Studio.
