...
- [ecg-box](https://github.com/JoelAtHome/ecg-box) — analog ECG firmware, plans, [`protocol.md`](https://github.com/JoelAtHome/ecg-box/blob/main/protocol.md); calibrate vs ritual: [`docs/tuning-workflow.md`](https://github.com/JoelAtHome/ecg-box/blob/main/docs/tuning-workflow.md); PC tuner scaffold: [`tools/pc-tuner/`](https://github.com/JoelAtHome/ecg-box/tree/main/tools/pc-tuner)  
