...
**Status:** Shipping phone contract through **v1.0.0-beta.32**; host light passes + FT bench/caregiver path recorded. **FlareTracker Bridge Companion** is live (**v1.0.6**). **Priority:** Feather profiles/calibrate → Tuner. β.29 Connect Feather; β.31 update-check; β.32 demo coeffs = patch/torso known-good.
